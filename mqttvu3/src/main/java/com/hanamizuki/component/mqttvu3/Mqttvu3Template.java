...
import com.hanamizuki.component.mqttvu3.constants.ControlVar;
...
import com.hanamizuki.component.mqttvu3.enums.Channel;
...
import com.hanamizuki.component.mqttvu3.processor.Sender;
import com.hanamizuki.component.mqttvu3.processor.ToSubscribe;
import com.hanamizuki.component.mqttvu3.processor.meta.AbstractMqttAssembleAdapter;
...
import com.hanamizuki.component.common.utils.ReflectionUtil;
...
import static com.hanamizuki.component.mqttvu3.constants.ControlVar.*;
...
public class Mqttvu3Template extends AbstractMqttAssembleAdapter implements ToSubscribe {
    ...
    private void beforeSend(String topic) {
        if (!isCompleted) {
            throw new RuntimeException("Sender is not already.");
        }
        if (topic == null) {
    ...
    public void send(Object payload) {
        ...
        String topic = box.getDefaultPublishTopic();

        assert topic != null;
        this.beforeSend(topic);
        sender.send(topic, box.getQos(), payload);
    }
